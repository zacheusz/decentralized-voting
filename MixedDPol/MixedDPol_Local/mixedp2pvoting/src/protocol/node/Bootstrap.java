...
//	private List<E_NodeID> proxyView;
	...
	//	dump("Bootstrap " + id.getName() + " is born (nb ballots=" + Node.NB_BALLOTS +")");
		dump("Bootstrap " + id.getName() + " is born (nb ballots=" + getNB_BALLOTS() +")");		// Return Number Ballots of this node
	}
...
private void receiveDEAD(){
	...
	private void receiveGMAV(GMAV_MSG msg) throws UnknownHostException, IOException {
	    ...
	    int nb_BALLOTS=((E_NodeID)msg.getSrc()).NB_BALLOTS;		// Lire le nb_BALLOTS de lemetteur 
            ...
            {
                viewSize = nb_BALLOTS;		//	Modif NB_BALLOTS -> nb_BALLOTS
							...
							if(getGroupId(id) == msg.getGroupId() && !id.equals(msg.getSrc())) {
                                               ...
                                               //                     System.out.println("case 1");
                                                               ...
                                                               // else if((csize.intValue())<Node.NB_BALLOTS)
                                                                ...
                                                                else if((csize.intValue())<nb_BALLOTS)			// Modif nb_BALLOTS
                                                                {
...
//                                            }
					...
					//	if(viewSize==Node.NB_BALLOTS && subView.size() < viewSize) {
						if(viewSize==nb_BALLOTS && subView.size() < viewSize) { 		// modif nb_BALLOTS 
