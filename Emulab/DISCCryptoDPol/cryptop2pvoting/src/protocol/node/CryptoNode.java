...
public class CryptoNode extends Node {
    ...
    private static int VOTE_DELAY = 360 * 1000;// Delay before voting: 50 seconds
    //   private static int CLOSE_VOTE_DELAY = 490 * 1000; 				// Duration of the local voting phase: 1 minute
    private static int CLOSE_COUNTING_DELAY = 500 * 1000;		// Duration of the local counting phase: 1 minute
