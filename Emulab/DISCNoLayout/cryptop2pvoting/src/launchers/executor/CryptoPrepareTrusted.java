	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < args.length; i++) {
			...
			i++;
                ...
                CryptoNode.numClusters = (int)Math.ceil( (CryptoNode.VOTERCOUNT / (CryptoNode.kvalue * Math.log(CryptoNode.VOTERCOUNT))));
         //       CryptoNode.nodesPerCluster =  (int)(Math.floor(CryptoNode.VOTERCOUNT/CryptoNode.numClusters));
...
//                    CryptoNode.numClusters++;
                ...
                while(CryptoNode.nodesPerCluster*CryptoNode.numClusters>=CryptoNode.VOTERCOUNT)
                        CryptoNode.numClusters--;
                CryptoNode.numClusters++;
                
                CryptoNode.MINTALLIES = CryptoNode.VOTERCOUNT / 2 + 1;
...
*/
                System.out.println(" Create new keypairs ."+"npc: "+CryptoNode.nodesPerCluster+ "mint: "+ CryptoNode.MINTALLIES+"voters: "+CryptoNode.VOTERCOUNT+"nc "+CryptoNode.numClusters);
