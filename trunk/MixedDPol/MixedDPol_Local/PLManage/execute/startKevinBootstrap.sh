...
cd /home/$LOGIN_NAME/myfiles/tmp/$BOOTSTRAP; java -classpath package/$PROJECT_NAME/bin $BOOTSTRAPCLASSNAME -fileName $BOOTSTRAP-$2$BOOTSTRAP_PORT.out -name $BOOTSTRAP -port $BOOTSTRAP_PORT -nbGroups $NB_GROUPS  -nbBallots $NB_BALLOTS_MAX # modif ajout de _MAX
cd -;
