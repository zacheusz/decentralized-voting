...
cd -;
ssh -i $SSHHOME -o ConnectTimeout=$SSH_TIMEOUT -o StrictHostKeyChecking=no ${LOGIN_NAME}@$home_node "java -classpath ../../$PROJECT_NAME/bin paillierp.testingPaillier.Testing -bitsnum 1024 -servers 10 -threshold 5 -rounds 3 -candidatesLength 2"
