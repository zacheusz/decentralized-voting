...
fit average(x) "planetlabk1.data" using ($8/1000):3 via a,b

average_expected(x)=760*(x-0.5)-80

expected(x)=N*(2*x-1)
bound(x)=N*(2*x-1)-m*(6*1+2)
...
plot "planetlabk1.data" using ($8/1000):($7/100) title "" with points pt 2 lc 1 ps 0.8
...
plot -1000 title "Valid binary output" with points pt 2 lt 1,\
     ...
     "planetlabk1.data" using ($8/1000):3 title "Average outcome" with points pt 8 ps 0.8 lc 1,\
