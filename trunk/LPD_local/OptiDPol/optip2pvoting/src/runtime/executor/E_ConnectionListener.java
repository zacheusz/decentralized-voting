...
public class E_ConnectionListener implements Runnable {
	...
	public E_ConnectionListener(int port, TaskManager tm, Receiver r) {
		this.port = port;
		this.tm = tm;
		this.r = r;
	}
				...
				try {
					...
					while (true) {
						...
						try {
							...
							System.out.println(((SimpleNode) r).toString()
									+ " : " + t.getMessage());
							t.printStackTrace();
						}
